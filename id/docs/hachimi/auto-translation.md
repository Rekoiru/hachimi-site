...
- Alat-alat tersebut dimaksudkan untuk dijalankan pada PC. Sedangkan pada Android, kamu mungkin hanya perlu menyesuaikan `sugoi_url` ke alamat IP PC kamu yang sedang menjalankan perangkat lunak terjemahan tersebut.
...
**"Terjemahkan otomatis UI" tidak disarankan untuk penerjemah ini.**
