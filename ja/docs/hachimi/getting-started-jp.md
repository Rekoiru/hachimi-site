...
2025/9/24 の大型アップデート以降、v0.14.2 以降の Hachimi Egde を使用する必要があります。
...
::: warning
Hacimi Edge にアップグレードした際に表示されない場合は、Hachimi のメニューを表示し、セットアップを完了させてください。古い翻訳や壊れたテクスチャなどの問題が発生する可能性があります。
:::
